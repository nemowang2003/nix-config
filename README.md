...
- `packages/`: Reusable executables (`codex-notify`, [codex-wecom-relay](packages/codex-wecom-relay/README.md), `generic-rebuild`), exported as the flake's `packages` output.
